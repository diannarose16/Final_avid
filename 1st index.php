...
$stmt = $pdo->prepare("SELECT survey_completed FROM users WHERE email = ?");
$stmt->execute([$email]);
    ...
    <div class="product-group">
        <div class="product-card">
            <div class="product-image">
                <img src="assets/image/product/products/S nature made/Nature Made Fish Oil 1200mg 50-200-300 softgels exp 2026.png" alt="Nature Made Fish Oil">
                <div class="discount-badge">56% OFF</div>
            </div>
            <div class="product-info">
                <p class="product-name">Nature Made Fish Oil 1200mg 50-200-300 softgels exp 2026</p>
                <hr>
                <p class="product-price">₱1099</p>
                <p class="product-old-price">₱1200</p>
                <p class="product-save">Save - ₱199</p>
            </div>
        </div>
        </div>
    </div>
...
<div class="product-container">
    ...
    <div class="products">
        <div class="product-item">
            <img src="assets/image/product/products/P Dove/Dove Soap beuty cream bar.png" alt="Dove Soap beuty cream bar">
            <p class="product-name">Dove Soap beuty cream bar</p>
            <p class="price">₱200.00</p>
            <div class="status-deals">SELLING FAST</div>
        </div>
        <div class="product-item">
            <img src="assets/image/product/products/P Olay/OLAY Face Wash Brighten Anti-Aging Regenerist Moisture Black Spots Vit E B3 2pcs.png" alt="OLAY Face Wash">
            <p class="product-name">OLAY Face Wash Brighten Anti-Aging Regenerist Moisture Black Spots Vit E B3 2pcs</p>
            <p class="price">₱500.00</p>
            <div class="status-deals">SELLING FAST</div>
        </div>
        <div class="product-item">
            <img src="assets/image/product/products/W oura ring/Oura Ring rose gold.png" alt="Oura Ring rose gold">
            <p class="product-name">Oura Ring rose gold</p>
            <p class="price">₱2 500.00</p>
            <div class="status-deals">SELLING FAST</div>
        </div>
        <div class="product-item">
            <img src="assets/image/product/products/F under armor/Under armor duffel bag.png" alt="Under armor duffel bag">
            <p class="product-name">Under armor duffel bag</p>
            <p class="price">₱150.00</p>
            <div class="status-deals">SELLING FAST</div>
        </div>
        <div class="product-item">
            <img src="assets/image/product/products/V Vitafusion/Vitafusion Power C Orange Gummies 150-Count Vitamin C Supplement for Adults.png" alt="Vitafusion Power">
            <p class="product-name">Vitafusion Power C Orange Gummies 150-Count Vitamin C Supplement for Adults</p>
...
<div class="product-section">
    ...
    <div class="product-grid">
        ...
        <!-- Add other product items here -->
        <div class="product-item">
            <img src="assets/image/product/products/V Vitafusion/Vitafusion Gorgeous Hair, Skin & Nails Multivitamins, 100 Gummies.png">
        ...
        <!-- Add other product items here -->
        <div class="product-item">
            <img src="assets/image/product/products/S nature made/Nature Made Prenatal Multivitamin + 200 mg DHA Softgels, 110 Count to Support Baby's Development.png">
            <p class="product-name">Nature Made Prenatal Multivitamin + 200 mg DHA Softgels, 110 Count to Support Baby's Development</p>
            <p class="price">₱7000.00</p>
            <div class="status-for">NEW ARRIVAL</div>
        </div>
        <!-- Add other product items here -->
        ...
        <!-- Add other product items here -->
        <div class="product-item">
            <img src="assets/image/product/products/P Dove/Original Nourished and Smooth Antiperspirant Roll-on.png">
